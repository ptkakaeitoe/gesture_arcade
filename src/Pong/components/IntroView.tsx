...
const IntroView: React.FC<IntroViewProps> = ({ onEnter, onBack, cameraLabel }) => {
    return (
        <div className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-[#050505] text-white selection:bg-cyan-500 selection:text-black">
            ...
            <div className="relative z-20 flex flex-col items-center gap-12 max-w-5xl mx-auto px-6 w-full">
                ...
                <div className="text-center space-y-6 relative">
                    ...
                    <p className="max-w-md mx-auto text-slate-400 font-mono text-sm md:text-base leading-relaxed tracking-wide">
                        <span className="text-cyan-400 text-xs mt-2 block tracking-[0.2em]">
                            MOVE HAND TO DEFLECT
                        </span>
                        <br />
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-white/5 skew-x-[-12deg] border border-white/10 transition-all duration-300 group-hover:bg-cyan-500 group-hover:border-cyan-500" />

                    {/* Glitch Effect Layers */}
                    <div className="absolute inset-0 bg-cyan-500/20 skew-x-[-12deg] translate-x-2 translate-y-2 opacity-0 group-hover:opacity-100 transition-all duration-100" />
